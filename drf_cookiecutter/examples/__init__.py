from drf_cookiecutter.examples.auth_requests import (
    user_login_curl,
    user_logout_curl,
...
from drf_cookiecutter.examples.auth_responses import (
...
from drf_cookiecutter.examples.user_requests import profile_update_curl
from drf_cookiecutter.examples.user_responses import (
