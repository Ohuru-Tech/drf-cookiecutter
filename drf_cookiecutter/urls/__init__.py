...
from drf_cookiecutter.urls.auth_urls import rest_auth_urls
from drf_cookiecutter.urls.swagger_urls import swagger_urlpatterns
from drf_cookiecutter.urls.versioned_urls import versioned_urls
