...
from drf_cookiecutter.apps.accounts.models.user_models import User
from drf_cookiecutter.apps.accounts.serializers.user_serializers import (
    ProfileCreateUpdateSerializer,
    UserInfoSerializer,
)
from drf_cookiecutter.apps.common.custom_auto_schema import CustomAutoSchema
from drf_cookiecutter.docs.user_docs import ProfileUpdate
